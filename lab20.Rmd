...
**Answer**:when the carrats of the diamond increase, the price also increases. 
...
**Answer**: YES, because the range 7729~7784 does not include 5500. 
...
**Answer**:if the slope contains only values that all negative, or all postive, there will be significant correlation between two varibles. 
...
**Answer**:5763.67- 60*29.65

Describe in words the estimate of the slope in terms of the dataset.

**Answer**:for every increase in the unit of depth, the price of diamond will decrease 29.65.
...
**Answer**: The value will decrease as the depth of diamonds increases. 
...
**Answer**:4045.3 - 50*102.2 + 2*7765.1

Are both of the slopes in the model statistically significant? What are
their signs?

**Answer**:Yes, both of the slopes are significant because the sign of depth is always negative, and the sign of carat is positive. 
...
**Answer**:the price of the diamond will decrease as the depth of the diamond increases, and the price of diamond will increase as the weight of the diamond increases.
