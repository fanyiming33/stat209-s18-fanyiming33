...
The value of the 30th percentile is 34.5, which means less than 30 pecent cereal has a socre below 34.5, and rest of cereal has a score above 34.5. 
...
**Answer**:The 80th percentile is 30, which means about 80 pecent of the prices of tea are lower than 30, and about 20 percent of the prices of tea are higher than 30. 
...
**Answer**:the reviews for the most expensive 20% of teas tends to be less than the reviews for the relatively cheap teas. 
...
**Answer**:The variation of the white tea prices tend to be smaller than the entire dataset. 
...
ggplot(tea_type, aes(price_mean, score_mean)) +
  geom_point(aes(size = num_reviews_mean)) +
...
**Answer**: There is not a relationship between the price of the teas and the scores of the teas.
